			...
			<div class="card mt-5" style="width: 100%; margin: auto;">
				...
				<div class="card-body">
					<dl>
						...
						<dd>- Un jugador que reciba esta tarjeta estará amonestado: En caso de que un jugador sea amonestado dos veces en un mismo encuentro recibirá una tarjeta roja. <mark>Un jugador que acumule 5 tarjetas amarillas (la acumulación no tiene que ser continúa) será suspendido la jornada siguiente.</mark></dd>
						
						<dt>10.1.2 Roja</dt>
						<dd>- Expulsión del jugador infractor, dejando el equipo en inferioridad numérica. La sanción se determinará de acuerdo con el tabulador de sanciones según el reporte arbitral.</dd>
						
						<dt>10.1.2.1</dt>
						<dd><mark>Si un mismo jugador recibe tres tarjetas rojas (directa) en el torneo, quedará expulsado del mismo.</mark> Su reincorporación será evaluada por el Comité Organizador de exalumnos y el Liceo de Monterrey.</dd>
